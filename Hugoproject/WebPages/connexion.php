            ...
            <div class="row md">
                ...
                <div class="col md">
                    ...
                    <div class="form-floating">
                        <input name="email" type="email" class="form-control connexion" id="floatingInput" placeholder="name@example.com" required>
                        <label for="floatingInput">Adresse Email</label>
                    </div>
                    <div class="form-floating">
                        <input name="mdp" type="password" class="form-control connexion" id="floatingPassword" placeholder="Mot de Passe" required>
